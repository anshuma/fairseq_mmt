...
class EarlyStopping:
    def __init__(self, patience=3, verbose=False, delta=0, path='best_model_image_caption'):
    ...
    def __call__(self, score, model, tokenizer):
...
def train_translation_model(translation_model, translation_tokenizer, clip_model, clip_processor, train_dataloader,
                            valid_dataloader, optimizer, scheduler, device, generation_config, num_epochs=3,
                            patience=3):
    early_stopping = EarlyStopping(patience=patience, verbose=True, path='best_model')
    ...
    for epoch in range(num_epochs):
        ...
        early_stopping(bleu_score.score, translation_model, translation_tokenizer)
...
translation_model.save_pretrained('final-fine-tuned-translation-model_ImageCaption')
translation_tokenizer.save_pretrained('final-fine-tuned-translation-tokenizer_ImageCaption')
