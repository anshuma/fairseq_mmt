...
def get_visual_embedding_blip(image_path):
    ...
    vision_outputs = blip_model.image_model(pixel_values=inputs['pixel_values'], return_dict=True)
...
train_data = load_data('small_train')
...
trainer.save_model("./finetuned_model_VisualBERT_small_blip")
tokenizer.save_pretrained("./finetuned_model_VisualBERT_small_blip")
