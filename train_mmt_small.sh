...
save_dir=small_dataset/checkpoints/$task/vit_base_patch14_decoderside
...
arch=image_multimodal_transformer_SA_On_Decoder
...
image_feat_path=small_dataset/data/vit_base_patch16_384
image_feat_dim=768
