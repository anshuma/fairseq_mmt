...
@register_model("image_multimodal_transformer_SA_On_Decoder")
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def forward(
        ...
        #print('inside build module forward',encoder_out, flush=True)
        print('inside build module forward prev_output_tokens', prev_output_tokens.shape)
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def forward(
        ...
        """
        print("anshuma: TransformerDecoder",flush=True)
    ...
    def extract_features_scriptable(
        ...
        for idx, layer in enumerate(self.layers):
            if incremental_state is None and not full_context_alignment:
                ...
                self_attn_mask = None
            #print('before calling TransformerDecoderLayer encoder_out',encoder_out)
...
@register_model_architecture("image_multimodal_transformer_SA_On_Decoder", "image_multimodal_transformer_SA_On_Decoder")
...
@register_model_architecture("image_multimodal_transformer_SA_On_Decoder", "image_multimodal_transformer_SA_On_Decoder_top")
def image_multimodal_transformer_SA_On_Decoder_top(args):
